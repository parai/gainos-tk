 ...
 * Generated by GaInOS-TK Studio at 2013-06-01:09-25-27.
...
const Dcm_DspSessionRowType *vDcmRoutineInfo1_sessionRefList[] = {
	&DspSessionList[0],//vSessionControl_1
	&DspSessionList[DCM_SESSION_EOL_INDEX]
};
...
const Dcm_DspRoutineType  DspRoutineList[] = {
	{//vRoutine1
		 ...
		 /* DspRoutineInfoRef = */ &DspRoutineInfoList[0],//vDcmRoutineInfo1
