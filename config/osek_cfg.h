 ...
 * Generated by GaInOS-TK Studio at 2013-06-30:23-38-02.
...
#endif
/*  ====================  RESOURCE ======================= */
#define cfgOSEK_RESOURCE_NUM 5
#define RES_SCHEDULER 0
#define RES_SCHEDULERPri PRIORITY(cfgOSEK_MAX_PRIO)
	//it had been assigned to [ ]
#define Resource1 1
#define Resource1Pri PRIORITY(1)
	//it had been assigned to [ Task1, Task5, ]
#define Resource2 2
#define Resource2Pri PRIORITY(4)
	//it had been assigned to [ Task1, Task2, ]
#define Resource3 3
#define Resource3Pri PRIORITY(4)
	//it had been assigned to [ Task3, Task5, ]
#define Resource4 4
#define Resource4Pri PRIORITY(6)
	//it had been assigned to [ Task1, Task3, Task4, ]
