 ...
 * Generated by GaInOS-TK Studio at 2013-06-29:15-35-08.
...
#define Task3Pri PRIORITY(1)
#define Task4Pri PRIORITY(3)
...
#define AlarmNoFunc 0
#define AlarmError 1
#define AlarmNoFunc_AutoStartTime 100
#define AlarmNoFunc_AutoCycleTime 100
#define AlarmError_AutoStartTime 100
#define AlarmError_AutoCycleTime 100
#define AlarmNoFuncMode ( OSNONEAPPMODE )
#define AlarmErrorMode ( OSNONEAPPMODE )
#if !defined(MACROS_ONLY)
IMPORT ALARM(AlarmNoFunc);
