...
#
# Created: Sun Jul 14 17:56:09 2013
...
class Ui_cd_schedtbl(object):
    def setupUi(self, cd_schedtbl):
        ...
        self.groupBox.setGeometry(QtCore.QRect(20, 0, 871, 181))
        self.groupBox.setObjectName(_fromUtf8("groupBox"))
        self.layoutWidget = QtGui.QWidget(self.groupBox)
        self.layoutWidget.setGeometry(QtCore.QRect(388, 20, 471, 161))
        ...
        self.spbxSchedTblMaxAdvance.setEnabled(False)
        ...
        self.spbxSchedTblMaxRetard.setEnabled(False)
        ...
        self.groupBox_2.setGeometry(QtCore.QRect(20, 190, 871, 391))
        ...
        self.tabSchedTblCfg.setGeometry(QtCore.QRect(390, 170, 481, 80))
        self.tabSchedTblCfg.setObjectName(_fromUtf8("tabSchedTblCfg"))
        self.tab = QtGui.QWidget()
        self.tab.setObjectName(_fromUtf8("tab"))
        self.widget = QtGui.QWidget(self.tab)
        self.widget.setGeometry(QtCore.QRect(10, 10, 441, 27))
        ...
        self.spbxSchedEpOffset = QtGui.QSpinBox(self.widget)
        ...
        self.widget1.setGeometry(QtCore.QRect(10, 10, 401, 27))
        ...
        self.cmbxActTskId = QtGui.QComboBox(self.widget1)
        ...
        self.widget2.setGeometry(QtCore.QRect(10, 10, 461, 27))
        self.widget2.setObjectName(_fromUtf8("widget2"))
        self.horizontalLayout_11 = QtGui.QHBoxLayout(self.widget2)
        self.horizontalLayout_11.setMargin(0)
        self.horizontalLayout_11.setObjectName(_fromUtf8("horizontalLayout_11"))
        self.label_2 = QtGui.QLabel(self.widget2)
        self.label_2.setObjectName(_fromUtf8("label_2"))
        self.horizontalLayout_11.addWidget(self.label_2)
        self.cmbxSetTskId = QtGui.QComboBox(self.widget2)
        self.cmbxSetTskId.setMinimumSize(QtCore.QSize(170, 0))
        ...
        self.cmbxSetEnt = QtGui.QComboBox(self.widget2)
        self.cmbxSetEnt.setMinimumSize(QtCore.QSize(170, 0))
